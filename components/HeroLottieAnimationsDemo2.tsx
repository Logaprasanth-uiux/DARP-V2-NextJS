...
import currencypic from '@/assets/animations/Demo 2/currencypic-orange.json';
import currencypicInv from '@/assets/animations/Demo 2/currencypic-orange-inv.json';
...
export default function HeroLottieAnimationsDemo2({ classLeft, classRight }: HeroLottieAnimationsProps) {
