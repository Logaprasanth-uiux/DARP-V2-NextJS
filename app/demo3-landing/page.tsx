        ...
        <Container className={styles.contentContainer}>
          <div className={styles.placeholderCard}>
            <div className={styles.badgeRow}>
              <span className={styles.demoBadge}>Executive Workspace – Demo 3</span>
            </div>
            
            <h1 className={styles.placeholderTitle}>Dedicated Report Workspace</h1>
            <p className={styles.placeholderSubtitle}>
              Experience an alternative full-width browser workspace for reviewing compliance errors and communicating recovery tasks, supported by an integrated floating DARP AI Assistant.
            </p>

            <div className={styles.actionBlock}>
              <Button variant="primary" size="md" onClick={handleLaunchDemo3}>
