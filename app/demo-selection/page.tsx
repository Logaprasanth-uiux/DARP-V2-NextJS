      ...
      <main className={styles.mainContent}>
        <Container className={styles.contentContainer}>
          <div className={styles.titleSection}>
            <PageTitle className={styles.pageTitle}>Choose Assessment Demo</PageTitle>
            <Body className={styles.pageSubtitle}>Select a demo experience to continue.</Body>
          </div>
          ...
          <div className={styles.cardsGrid}>
            ...
            {/* DEMO 1 CARD */}
            <div onClick={handleLaunchDemo1} className={styles.cardWrapper}>
              <Card elevated className={styles.demoCard}>
                <CardContent className={styles.cardInner}>
                  <div className={styles.cardHeaderArea}>
                    <Badge variant="info" size="sm" className={styles.demoBadge}>Demo 1</Badge>
                    <h3 className={styles.demoTitle}>Guided Assessment</h3>
                  </div>
                  <p className={styles.demoDescription}>
                    Complete AI onboarding experience including document upload, validation, organization confirmation, and financial recovery assessment.
                  </p>
                  <div className={styles.cardFooterArea}>
                    <Button variant="primary" size="md" className={styles.launchButton} onClick={(e) => { e.stopPropagation(); handleLaunchDemo1(); }}>
                      Launch Demo →
                    </Button>
                  </div>
                </CardContent>
      ...
      <footer className={styles.footer}>
        <Container className={styles.footerContainer}>
          ...
          <div className={styles.footerRight}>
            <span className={styles.footerLink} onClick={handleBackToHome}>Home</span>
            <span>•</span>
            <span>Support</span>
          </div>
        </Container>
